...
public class WashingMachine extends Product{
    ...
    public WashingMachine(int id, String type_of_technique, String model, LocalDate release_date, String country_of_production, int guarantee_period, int price) {
        super(id, type_of_technique, model, release_date, country_of_production, guarantee_period, price);
    }

    public WashingMachine(String type_of_technique, String model, LocalDate release_date, String country_of_production, int guarantee_period, int price) {
        super(type_of_technique, model, release_date, country_of_production, guarantee_period, price);
    }

    public WashingMachine(String model, LocalDate release_date, String country_of_production, int guarantee_period, int price) {
